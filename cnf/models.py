...
class Organismo_de_socorro(ClaseModelo2):
...
class Pais(ClaseModelo):
    ...
    indicativo = models.CharField(max_length=10, null=True, blank=True)
...
class GestoResiduoHospitalario(ClaseModelo2):
    nitcc = models.CharField(max_length=20, unique=True)
    razonsocial = models.CharField(max_length=255)
    nombrereplegal = models.CharField(max_length=255, null=True, blank=True)
    telefono = models.CharField(max_length=30, null=True, blank=True)
...
class Escolaridad(ClaseModelo2):
    codigo=models.CharField(max_length=3, unique=True)
    descripcion = models.CharField(max_length=80)
...
class Pueblo_indigena(ClaseModelo2):
    codigo=models.CharField(max_length=3, unique=True)
    descripcion = models.CharField(max_length=80)
