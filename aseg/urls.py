...
from .views import importarmaestrobdua, Principal, importarmaestrocontributivo, \
	...
	delete_novlcregtipo12, report_novedadlc_csv_view, validacion_regsubsidiado, \
	validacion_regcontributivo, cruzar_bd_cont_Subs, cruzar_ms_mortalidad, \
	auditoriaTipodocNoValidoParaEdadCCSub, auditoriaTipodocNoValidoParaEdadTISub, \
	auditoriaTipodocNoValidoParaEdadRCSub
...
path('valid/rs', validacion_regsubsidiado, name='valid_rs'),
path('valid/rc', validacion_regcontributivo, name='valid_rc'),
path('cruzar/bd', cruzar_bd_cont_Subs, name='cruce_bd'),
path('cruzar/mortruaf', cruzar_ms_mortalidad, name='cruce_ms_mortalidadruaf'),
path('auditoria/mscc', auditoriaTipodocNoValidoParaEdadCCSub, name='auditoria_mscc'),
path('auditoria/msti', auditoriaTipodocNoValidoParaEdadTISub, name='auditoria_msti'),
path('auditoria/msrc', auditoriaTipodocNoValidoParaEdadRCSub, name='auditoria_msrc'),
